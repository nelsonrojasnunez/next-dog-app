...
describe('Page', () => {
  ...
  it('renders empty filters', () => {
    render(<Filters breedList={[]} handleLoadDogsImages={()=>console.log('')}/>)
  ...
  it('renders data in breed filter', () => {
    ...
    render(<Filters breedList={breeds} handleLoadDogsImages={()=>console.log('')}/>)
  ...
  it('renders items in gallery', () => {
    render(<Gallery dogImages={['https://images.dog.ceo/breeds/affenpinscher/n02110627_11365.jpg']} />)
